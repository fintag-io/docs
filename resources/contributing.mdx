...
2. **Clone Your Fork**: Clone your forked repository to your local machine.
   ...
   ```
    ```bash Python
   git clone https://github.com/your-username/fintag-py.git
   ```
    ```bash Rust
   git clone https://github.com/your-username/fintag-rust.git
   ```
    ```bash Go
   git clone https://github.com/your-username/fintag-go.git
   ```
   ```bash Swift
   git clone https://github.com/your-username/fintag-swift.git
   ```
   </CodeGroup>
