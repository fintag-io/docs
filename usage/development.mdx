...
fintag = FintagClient(api_url="<FINTAG_API_URL>", api_key="<FINTAG_API_KEY>")
...
func main() {
    fintag := fintag.NewFintagClient("<API_KEY>")
...
let fintag = FinTagClient(apiKey: "<FINTAG_API_KEY>", baseURL: "<FINTAG_API_URL>")
